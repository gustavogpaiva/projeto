...
namespace SGRIMvc.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            objFuncionario.Senha_Funcionario = "********";
        ...
        public ActionResult Create(FUNCIONARIOS objFuncionario)
        {
            ...
            objFuncionario.Senha_Funcionario = senha;
            MailMessage msg = new MailMessage();
            msg.From = new MailAddress("karine.leles@gmail.com");
            msg.To.Add(objFuncionario.Login_Funcionario);
        ...
        #region Criar Login e Senha para Funcionários
        /// <summary>
        ...
        #region Listar Funcionários com as opções CRUD
        /// <summary>
        ...
        #region Mensagens de Erro/sucesso
